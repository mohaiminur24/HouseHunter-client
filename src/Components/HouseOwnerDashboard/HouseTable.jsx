...
const HouseTable = ({house,index,setRefetch,refetch}) => {
    ...
    const {HouseEmail,HouseOwner,Phone,abilitydate,address,bedroom,name,picture,_id} = house;
    const handleDelete = async(id)=>{
        const result = await axiosSecure.delete(`http://localhost:3000/deleteuserroute?id=${id}`)
